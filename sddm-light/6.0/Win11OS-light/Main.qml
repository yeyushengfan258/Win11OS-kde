    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Win11OS-light/assets/suspend_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Win11OS-light/assets/restart_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Win11OS-light/assets/shutdown_primary.svgz"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Win11OS-light/assets/switch_primary.svgz"
